...
const FeedStatusButton = (props) => {
  ...
  const { count, feed_type, setCount, is_self } = props;
...
const CommentCard = (props) => {
  ...
  return (
    <Grid item xs={12}>
      ...
      >
        <Grid item xs={2} sm={1}>
          <Avatar alt="Remy Sharp" variant="circle" className="big-avatar" />
        </Grid>
...
const CommnetWritingComponet = () => {
  const { comment, setComment } = useContext(ViewContext);
  ...
  return (
    <Grid container justify="center" alignContent="center">
      <Grid item xs={12}>
        ...
        >
          <Grid item xs={2} sm={1}>
            <Avatar alt="Remy Sharp" className="big-avatar" />
          </Grid>
          <Grid item xs={10} sm={11}>
            <TextField
